...
export PATH="$PATH:/home/nateb/projects/ncurses/todo"
export QT_ENABLE_HIGHDPI_SCALING=1
export GOOGLE_API_KEY="AIzaSyB6FDhBEnf1MYR0ByH-N2SfcpsyGB21doc"
...
function psmake(){
  if [ -z "$1" ]; then
    echo "Usage $0 <Problem Set Number>";
    return 1;
  fi
    mkdir "ps$1"
    cp ~/dmt.sty "./ps$1/"
...
# move resume from latex dir to C doc folder
